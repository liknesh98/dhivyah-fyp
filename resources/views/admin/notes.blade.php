    ...
    <div class="row justify-content-center">
        ...
        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div >
                        <a href="{{route('note_delete', ['id'=>$note->id])}}">Delete</a>
                    </div>
                    <div >
                        <a href="" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#edit_modal" onclick="edit_item('{{$note->id}}')">Edit</a>
                    </div>
                    <div>
                        {{$note->Filename}}
                    </div>
                ...
                @endforeach
                    ...
                    <script>
                        ...
                        {
                            var edit_data = @json($notes);
                            // var edit_fields = {!! json_encode($notes) !!};
