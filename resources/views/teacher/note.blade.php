...
<tr>
  ...
  <tr>
    ...
    <td>{{$not->Notetitle}}</td>
    <td>{{$not->subject}}</td>
    <td><a type="button" class="btn btn-light" href="/teacher/notes/{{$not->id}}" target="_BLANK">View</a>
    <a type="button" class="btn btn-danger" href="{{route('note_delete', ['id'=>$not->id])}}">Delete</a>
    </td>
  </tr>
   @endforeach
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content rounded">
                                ...
                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                    <form method="POST" action="{{ route('note_store') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row mb-3">
                                        <label class="col-md-4 col-form-label">{{ __('Subject') }}: </label>
                                            <select name="subject" class="col-md-4 col-form-select" aria-label="Default select example">
                                            @php
                                                $count = 0
                                            @endphp
                                        ...
                                        <div class="row mb-3">
                                        <label class="col-md-4 col-form-label">{{ __('Year') }}: </label>
